...
router.post('/:id/send-precheckin', requireRole('manager'), ctrl.sendPrecheckinLink);
router.post('/:id/reopen-precheckin', requireRole('manager'), ctrl.reopenPrecheckinLink);
